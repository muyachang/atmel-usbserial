/** \file
 *
 *  Main source file for the atmel-usbserial project. This file contains the main tasks of
 *  the project and is responsible for the initial application hardware configuration.
 */

#include "atmel-usbserial.h"

bool TC_Commanding = false;
...
ISR(USART1_RX_vect, ISR_BLOCK)
{
  ...
  if(temp == ESC) // A command from Testchip about to come or about to end
